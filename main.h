...
int handle_write_char(char c, char buffer[],
	int flags, int width, int precision, int size);
int write_number(int is_positive, int e_j, char buffer[],
	int flags, int width, int precision, int size);
int write_num(int e_j, char bff[], int flags, int width, int precision,
	int length, char padd, char extra_c);
int write_pointer(char buffer[], int e_j, int length,
	int width, int flags, char padd, char extra_c, int padd_start);

int write_unsgnd(int is_negative, int e_j, char buffer[],
	int flags, int width, int precision, int size);
